...
public class Activity_BrokarageList extends AppCompatActivity {
    ...
    private class MenufacturerInfoTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            response = DummyMethod.requestMenufacturerList();
        ...
        protected void onPostExecute(Void result) {
            ...
            manufactureAdpater = new ManufactureAdpater(Activity_BrokarageList.this, Stocklist);
