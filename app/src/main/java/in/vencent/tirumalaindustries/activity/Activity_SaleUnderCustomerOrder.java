...
public class Activity_SaleUnderCustomerOrder extends AppCompatActivity {
    ...
    private class CustomerOrderTask extends AsyncTask<Void, Void, Void> {
            ...
            if (!response.contentEquals(""))
            {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++)
                    {
                        ...
                        PreferenceUtil.putInvoiceId(Activity_SaleUnderCustomerOrder.this, obj.getInt("invoice_id"));
                        OrderTotalBillInfo orderTotalBillInfo = new OrderTotalBillInfo(resObj.getString("total"));
                        PreferenceUtil.putTotal(Activity_SaleUnderCustomerOrder.this,resObj.getString("total"));
        ...
        protected void onPostExecute(Void result) {
            ...
            customerOrderListAdpater =new CustomerOrderListAdpater(Activity_SaleUnderCustomerOrder.this, showCustomerorder);
