...
import in.vencent.tirumalaindustries.orders.Activity_ChangeConfirmedtoDispatched;
import in.vencent.tirumalaindustries.rowitemlist.RowItemConfirmedOrderInfo;

public class ChangeConfirmedDispatchedAdapter extends RecyclerView.Adapter<ViewHolderCustomerOrdersList> {
    ...
    public ChangeConfirmedDispatchedAdapter(Context context, ArrayList<RowItemConfirmedOrderInfo> confirmedOrderInfo) {
