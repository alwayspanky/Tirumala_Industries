...
public class SalemanagerOrderAdpater extends RecyclerView.Adapter <ViewHolderSaleManagerList>{

    public Context context;
    ArrayList<RowItemAdminAllorderInfo> itemLists;

    public SalemanagerOrderAdpater(Context context, ArrayList<RowItemAdminAllorderInfo> adminallorderInfo) {
