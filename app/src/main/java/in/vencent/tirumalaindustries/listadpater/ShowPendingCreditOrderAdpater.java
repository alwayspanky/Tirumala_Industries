...
public class ShowPendingCreditOrderAdpater extends RecyclerView.Adapter<ViewHolderAlldataShowlists> {

        Context context;
        ArrayList<RowItemCustomerOrderInfoList> itemsList;

    public ShowPendingCreditOrderAdpater(Context context, ArrayList<RowItemCustomerOrderInfoList> showCustomerorder) {
