...
public class Activity_showConfirmedOrderLists extends AppCompatActivity {

    Toolbar toolbar;
    RecyclerView recyclerView;
    ShowConfirmOrderListsAdapter showConfirmOrderListsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Activity_showConfirmedOrderLists.this, Activity_OrderDashBorad.class);
    ...
    private class ShowConfirmTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            response = DummyMethod.requestConfirmedOrder(customer_id, p_staus);
        ...
        protected void onPostExecute(Void result) {
           ...
           showConfirmOrderListsAdapter =new ShowConfirmOrderListsAdapter(Activity_showConfirmedOrderLists.this, confirmedOrderInfo);
            recyclerView.setAdapter(showConfirmOrderListsAdapter);
        }
    }
