...
public class Activity_ShowDistpatchedOrder extends AppCompatActivity {

    Toolbar toolbar;
    RecyclerView recyclerView;
    ShowDispatchedOrderAdapter showDispatchedOrderAdapter;
    ArrayList<RowItemCustomerOrderStatusWise> confirmedOrderInfo;
    int customer_id, p_staus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PreferenceUtil.putCustomerMobile(Activity_ShowDistpatchedOrder.this, customerMobile);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            Intent intent = new Intent(Activity_ShowDistpatchedOrder.this, Activity_ChangedDispatchedtoDelivery.class);
    ...
    private class ShowConfirmTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            //response = DummyMethod.requestDispatchedOrder(customer_id, p_staus);

            response = DummyMethod.requestStatusOrderWise(order_id, p_staus);
            if (!response.contentEquals(""))
            {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++)
                    {
                        ...
                        PreferenceUtil.putOrderId(Activity_ShowDistpatchedOrder.this, obj.getInt("invoice_id"));
                    }
        ...
        protected void onPostExecute(Void result) {
            ...
            showDispatchedOrderAdapter =new ShowDispatchedOrderAdapter(Activity_ShowDistpatchedOrder.this, confirmedOrderInfo);
            recyclerView.setAdapter(showDispatchedOrderAdapter);
        }
    }
    ...
    private ArrayList<RowItemCustomerOrderStatusWise> getconfirmcustomerorder() {
        ...
        for (int i = 0; i < GlobalData.customerOrderStatusWiseInfos.size(); i++) {
            ...
            items.setQty_bag(GlobalData.customerOrderStatusWiseInfos.get(i).qty_bag);
            items.setQty_size(GlobalData.customerOrderStatusWiseInfos.get(i).qty_size);
