...
import in.vencent.tirumalaindustries.listadpater.ShowConfirmOrderListsAdapter;
...
public class Activity_ChangeConfirmedtoDispatched extends AppCompatActivity {
    Toolbar toolbar;
    ...
    String custmobile, salemangerno;
    Button submit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        custmobile = getIntent().getStringExtra("customer_mobile");
        order_id = getIntent().getIntExtra("order_id", 0);
        salemangerno = PreferenceUtil.getManagerMobile(Activity_ChangeConfirmedtoDispatched.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              SmsOrderCnfirmedtask smsOrderCnfirmedtask = new SmsOrderCnfirmedtask(custmobile, salemangerno, order_id);
                smsOrderCnfirmedtask.execute((Void)null);
                Intent intent = new Intent(Activity_ChangeConfirmedtoDispatched.this, Activity_OrderDashBorad.class);
    ...
    private class ShowConfirmTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            response = DummyMethod.requestChangeCOnfirmtoDispatched(customer_id, p_staus);
        ...
        protected void onPostExecute(Void result) {
            ...
            changeConfirmedDispatchedAdapter =new ChangeConfirmedDispatchedAdapter(Activity_ChangeConfirmedtoDispatched.this, confirmedOrderInfo);
            recyclerView.setAdapter(changeConfirmedDispatchedAdapter);
        }
    }
    ...
    private class SmsOrderCnfirmedtask extends AsyncTask<Void, Void, Void> {

        private final String mCustMobile, mManagerMobile;
        private final int mOrderId;
        private String response;

        public SmsOrderCnfirmedtask(String custmobile, String salemangerno, int order_id) {
            this.mCustMobile = custmobile;
            this.mManagerMobile = salemangerno;
        ...
        protected Void doInBackground(Void... voids) {
            ...
            response = DummyMethod.requestSmsConfirmOrder(mCustMobile, mManagerMobile, mOrderId);
        ...
        protected void onPostExecute(Void result) {
            super.onPostExecute(result);
            Toast.makeText(Activity_ChangeConfirmedtoDispatched.this, "Sucess", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(Activity_ChangeConfirmedtoDispatched.this, Activity_OrderDashBorad.class);
            startActivity(intent);
