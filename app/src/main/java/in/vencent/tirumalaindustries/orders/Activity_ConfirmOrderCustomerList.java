...
public class Activity_ConfirmOrderCustomerList extends AppCompatActivity {

    Toolbar toolbar;
    RecyclerView recyclerView;
    DsipatchedOrderAdpter dsipatchedOrderAdpter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(Activity_ConfirmOrderCustomerList.this, Activity_ShowConfirmsOrders.class);
    ...
    private class ShowConfirmTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            response = DummyMethod.requestConfirmCustomerList(p_status);
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                       ...
                       ConfirmedOrderListInfo confirmedOrderListInfo = new ConfirmedOrderListInfo(obj.getInt("pid"), obj.getInt("invoice_id"),
                        ...
                        PreferenceUtil.putInvoiceId(Activity_ConfirmOrderCustomerList.this,  obj.getInt("invoice_id"));
                    }
        ...
        protected void onPostExecute(Void result) {
            ...
            dsipatchedOrderAdpter = new DsipatchedOrderAdpter(Activity_ConfirmOrderCustomerList.this, confirmedOrderInfo);
            recyclerView.setAdapter(dsipatchedOrderAdpter);
        }
    }
